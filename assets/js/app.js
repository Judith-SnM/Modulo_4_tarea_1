...
Consultorio.setPaciente = pacienteUno;
Consultorio.setPaciente = pacienteDos;
Consultorio.setPaciente = pacienteTres;

console.log(consultorio.buscarPorNombre("Berta"))
consultorio.mostrarTodosDatos()
